...
echo "terraform destroy -var=\"org_id=${org_id}\" -var=\"billing_account=${billing_account}\" -auto-approve"

##Run the Terraform Destroy to delete all the resources##
terraform destroy \
  -var="org_id=${org_id}" \
  -var="billing_account=${billing_account}" \
  -auto-approve

##Remove Terraform state file, lock.hcl file and .terraform folder##
